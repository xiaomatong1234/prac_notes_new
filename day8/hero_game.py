...
class Hero:
    ...
    def speak_lines(self,lines):
        ...
        """
        self.lines = lines
        print(f'魔法师{self.name}说："{self.lines}"!!!!\n')
...
class Mage(Hero):
    ...
    def skill(self):
        ...
        :return:
        """
        print(f'魔法师：{self.name}，血量：{self._blood}，攻击力：{self.attack}，释放了{self.magic}魔法技能!')

# 实例化对象
h = Hero('妲己',100,80)
# 调用英雄类的台词方法
h.speak_lines('主人的敌人，就是妲己的敌人')


# 实例化法师属性
m = Mage('诸葛亮',100,80,'火球术')
# 调用英雄类的台词方法
m.speak_lines('我是诸葛孔明，我有一计，可让敌人望风而逃')
# 调用法师的技能方法
m.skill()
